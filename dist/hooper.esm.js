...
var Carousel = {
  ...
  setup: function setup(props, context) {
    ...
    var slideHeight = ref(0);
    var slidesCount = ref(0);
    var trimStart = ref(0);
    var trimEnd = ref(1);
    var currentSlide = ref(null);
    var timer = ref(null);
    var defaults = ref({});
    var breakpoints = ref({});
    var delta = ref({
    ...
    var config = ref({});
    var containerHeight = ref(null);
    var containerWidth = ref(null);
    var lastScrollTime = ref(null);
    var startPosition = ref(null);
    var endPosition = ref(null);
    var hooperCarousel = ref(null);
    var list = ref(null);
    var track = ref(null);
    var slideBounds = computed(function () {
    ...
    var trackTransform = computed(function () {
    ...
    var trackTransition = computed(function () {
    ...
    return function () {
      ...
      }, renderSlides(context.slots.default())), h('div', {
